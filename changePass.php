    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="app-container" id="settings">
                <form class="" action="https://mars-remind.herokuapp.com/verify/verifyChangePass" method="POST">
                    <input type="text" placeholder="New Password" id="changePass" name="newPassword" required> 
                    <input type="submit" value="Change password 🔒" id="changePass-submit">
                </form>
            </div>
        </div>
